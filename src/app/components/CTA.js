...
export const CTA = () => {
  return (
    <div className="px-0 md:px-24 ">
      <div className="max-w-screen-xl mx-auto relative rounded-lg bg-gray-200 flex flex-col justify-center items-center text-center mt-5 md:mt-32 gap-6 py-24 overflow-hidden">
        <Image
          src={cta}
