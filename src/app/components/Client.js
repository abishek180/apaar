...
export const Client = () => {
  return (
    <div>
      ...
      <div className="md:flex md:flex-row md:justify-evenly md:gap-[115.082px] gap-5 mt-20 flex flex-col">
        <div className="flex flex-row justify-around  md:gap-[115.082px]">
          <div className="flex">
        ...
        <div className="flex flex-row justify-around md:gap-[115.082px] md:mt-0 my-4">
          <div className="flex">
