  ...
  return (
    <div className="max-w-screen-lg mx-auto">
      <div className=" flex flex-col justify-center items-center text-center md:gap-10 gap-5 md:mt-20 mt-10">
        ...
        <div>
          <p className="lg:text-xl font-medium text-[16px] w-[385px] md:w-[695px]">
            Empowering educators and students with innovative tools and
            resources
          </p>
        </div>
      </div>
      <div className="lg:flex lg:flex-row lg:gap-5 lg:mt-10 lg:p-6  flex flex-col justify-center items-center mt-10">
        <div className="md:w-[608px] md:h-[635px] w-[383px] h-[403px] rounded-3xl [background:linear-gradient(180deg,_#fff,_#ebf4ff)]  border-[1px] border-solid border-gainsboro-200 p-5">
          ...
          <Image src={dashboard2} alt="dashboard" className="h-[226px] md:h-[425px] lg:h-[425px]"/>
        </div>
        <div className="md:w-[608px] md:h-[635px] w-[383px] h-[403px] rounded-3xl [background:linear-gradient(180deg,_#fff_36.66%,_#fff9e1)]  border-[1px] border-solid border-gainsboro-200 p-5 lg:mt-0 mt-8">
          ...
          <Image src={dashboard3} alt="dashboard" className="h-[226px] md:h-[425px] lg:h-[425px]"/>
        </div>
      </div>
    </div>
  );
