...
export const Testimony = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center mt-40">
      <div className=" text-[52px] font-extrabold ">What they Say’s ?</div>
      ...
      <div className="flex gap-10 mt-10">
        <button className="bg-[#F8F8F8] rounded-[150px] p-4 flex justify-center items-center">
          <Image src={leftarrow} />
        </button>
        <button className="bg-[#2C2C2C] rounded-[50px] p-4 flex justify-center items-center">
