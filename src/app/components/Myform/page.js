...
export default function page() {
  return (
    <div className="md:flex md:justify-center md:items-center md:mt-12">
      <div className="flex flex-col md:flex md:flex-row md:justify-center md:items-center shadow-[-4px_0px_41px_0px_rgba(8,_10,_9,_0.11)] w-[900px] rounded-[30px] bg-gray-300">
